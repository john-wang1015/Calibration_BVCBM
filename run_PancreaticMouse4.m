...
y_temp = Pancreatic_data(1:33,4);
y = zeros(32,1)';
y(1:14) = y_temp(1:14);
y(15:32) = y_temp(16:33);
%%
N = 1000; 
epsilon_final = 0; 
total_time = length(y);
...
%%
[part_vals, part_sim, part_s, ~, ~, ~,dist_history,sims_history] = smc_abc_rw_par(y,sim_params,dist_func,prior,N,epsilon_final,a,c,p_acc_min,'pancreatic mouse 4');
